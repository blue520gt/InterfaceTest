...
//  }
const link = "http://119.90.57.29:15502";
setTimeout(function() {
    ...
    //资讯管理：置顶的接口
    axios.request({
        url: link + "/api/news/updateTop/427",
        method: "get",
        params: {
    ...
    //资讯管理：取消置顶的接口
    axios.request({
        url: link + "/api/news/unUpdateTop/411",
        method: "get",
        params: {
    ...
    //新公示公告：新公示公告发布的接口
    axios.request({
        url: link + "/api/news/updateNewFbzt",
        method: "post",
        params: {
            "id": 520
        },
    ...
    //新公示公告：新公示公告取消发布的接口
    axios.request({
        url: link + "/api/news/updateNewQxFbzt",
        method: "post",
        params: {
            "id": 520
        },
    ...
    //公示公告：招标公告查询的接口
    axios.request({
        url: link + "/api/CqjyGcztb/selectCqjyGcztbPage",
        method: "post",
        params: {
    ...
    //公示公告：招标公告添加的接口
    axios.request({
        url: link + "/api/CqjyGcztb/addCqjyGcztb",
        method: "post",
        params: {
    ...
    //公示公告：招标公告通过id查看的接口
    axios.request({
        url: link + "/api/CqjyGcztb/selectCqjyGcztbById",
        method: "post",
        params: {
    ...
    //公示公告：招标公告修改的接口
    axios.request({
        url: link + "/api/CqjyGcztb/updateCqjyGcztb",
        method: "post",
        params: {
    ...
    axios.request({
        url: link + "/api/CqjyGczbgg/selectCqjyGcztbAndCqjyGczbggById",
        method: "post",
        params: {
    ...
    axios.request({
        url: link + "/api/CqjyGczbgg/updateCqjyGczbgg",
        method: "post",
        params: {
    ...
    axios.request({
        url: link + "/api/CqjyGczbgg/addCqjyGczbgg",
        method: "post",
        params: {
    ...
    //公示公告：公示公告删除接口
    axios.request({
        url: link + "/api/CqjyGcztb/deleteCqjyGcztb",
        method: "post",
        params: {
    ...
    //公示公告：通过项目编号查询公示公告接口
    axios.request({
        url: link + "/api/MHJjdt/gsgg/selectCjgsByxmbh",
        method: "post",
        params: {
    ...
    //公示公告：查询中标公告接口
    axios.request({
        url: link + "/api/CqjyGczbgg/selectCqjyGcztbAndCqjyGczbggPage",
        method: "post",
        params: {
    ...
    //公示公告：中标公告删除接口
    axios.request({
        url: link + "/api/CqjyGczbgg/deleteCqjyGczbgg",
        method: "post",
        params: {
    ...
    //供应管理：查询的接口
    axios.request({
        url: link + "/api/CqjyCqzcgl/selectZcfxxAndZcxxExtByZcgltypeToPage",
        method: "post",
        params: {
            "pageNo": 1,
            "pageSize": 1,
    ...
    //供应管理：新增的接口
    axios.request({
        url: link + "/api/CqjyCqzcgl/addCqjyCqzcgl",
        method: "post",
        params: {

        },
        data: {
            "cqjyZcfxx": { "type": "1", "bdlx": "1", "bdlx2": "1", "xmbh": "", "zcgltype": "1", "countmjtype": "1", "sfscxmzstp": "1", "xzqhList": ["12", "120115", "120115002", "120115002001"], "name": "哈哈", "tel": "18512345678", "lxaddress": "北京市海淀区", "idcard": "789456199110100101", "countmj": "12.000", "token": "eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJ0anMxaiIsImV4cCI6MTU3NDY4MTQwNSwiaWF0IjoxNTc0MDc2NjA1LCJqdGkiOiI0YzQyZDdlNmRkNTA0OWJhYmJkYjExZjJkNzlkMTQ5MyJ9.Q6k0v2oRIW3Sxei7ak8FBQVbNPiU_fEgUtUdlQBLNoETzf4dRANrwrJL5w7urEAfcF5LJmjx-bAvpR20qXtc6w" },
            "cqjyTdxxList": [{ "dkxz": "1", "txqlr": "是", "ghyq": "符合", "tdxz": "1", "dl": "其他", "zlList": "天津市/宝坻区/宝平街道/华苑小区社区", "about": "", "myId": 1574079376344, "cqjyTdxxDsfzwList": [{ "dsfzwname": "地上附着12", "numbercount": "120", "qsgx": "权属" }], "tdxxTxqlrList": [{}], "cbfidcard": 789456199110100200, "jyqzbh": "经营20191118", "cbfmz": "哈哈", "cbftel": "18512345678", "dkname": "地块1", "mj": 12, "zeast": "东", "zsouth": "南", "zwest": "西", "znorth": "北", "dj": "等级", "qtms": "其他描述", "dkbm": "" }],
            "cqjyFzList": [],
            "cqjyZcxx": { "zctype": "2", "sfszczc": "0", "sfjnbzj": "1", "zffs": "1", "jyfs": "2", "clfs": "1", "jjfs": "1", "tdxzlb": "1", "jkhrzh": "912002010000022677100", "zhmc": "天津农村产权交易所农户承包土地经营权", "khyh": "中国邮政储蓄银行股份有限公司天津蓟县支行", "xmname": "宝坻区宝平街道华苑小区社区12亩耕地", "jnxs": "1", "srftj": "自然人需年满18周岁以上、70周岁以下具有完全民事行为能力。", "gpjg": "1500", "gpjgdw": "2", "zrfqttj": "转让相关其他条件", "zcyt": "畜牧业", "htmb": "87", "jybzj": "150", "jtjg": "150", "gpq": "5" },
            "cqjyXmtp": [{ "url": "/CQZCGL/1574079455507_5.jpg", "name": "5.jpg" }]
        }
    }).then(function(response) {
    ...
    //供应管理：修改的接口
    axios.request({
        url: link + "/api/CqjyCqzcgl/updateCqjyCqzcgl",
        method: "post",
        params: {
    ...
    //供应管理：通过id查询的接口
    axios.request({
        url: link + "/api/CqjyCqzcgl/selectCqjyCqzcglByIdAndZcgltype",
        method: "post",
        params: {
    ...
    //供应管理：置顶的接口
    axios.request({
        url: link + "/api/CqjyCqzcgl/updateZcfxxZD",
        method: "post",
        params: {
    ...
    //供应管理：取消置顶的接口
    axios.request({
        url: link + "/api/CqjyCqzcgl/updateZcfxxQXZD",
        method: "post",
        params: {
    ...
    //供应管理：推荐的接口
    axios.request({
        url: link + "/api/CqjyCqzcgl/updateZcfxxSftjTrue",
        method: "post",
        params: {
    ...
    //供应管理：查询所有类别数据的接口
    axios.request({
        url: link + "/api/CqjyCqzcgl/selectAll",
        method: "post",
        params: {
    ...
    //需求管理：查询的接口
    axios.request({
        url: link + "/api/CqjyCqxqgl/selectCqjyXmxxAndCqjyXqqfxxExtByZcgltypeToPage",
        method: "post",
        params: {
    ...
    //竞价管理：竞价中项目的条件查询接口
    axios.request({
        url: link + "/api/BZzjjxm/queryList",
        method: "post",
        params: {
    ...
    //竞价管理：竞价人名单接口
    axios.request({
        url: link + "/api/BZzjjxm/getJBidinfoList",
        method: "post",
        params: {
    ...
    //竞价管理：报价记录接口查询接口
    axios.request({
        url: link + "/api/BZzjjxm/getJBidinfoZcfList",
        method: "post",
        params: {
    ...
    //竞价管理：生成成交公示接口
    axios.request({
        url: link + "/api/BDcjxm/setToSccjgs",
        method: "post",
        params: {
